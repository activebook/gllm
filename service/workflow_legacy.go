...
// this code is legacy, don't use it anymore
// it's a prove of concept, i've replaced it with more powerful subagent tools
...
// 	fmt.Printf("\n %sAgent:%s %s%s (%s%s%s)\n", workflowColor, workflowResetColor, workflowColor, agent.Name, agentRoleColor, agent.Role, workflowResetColor)
